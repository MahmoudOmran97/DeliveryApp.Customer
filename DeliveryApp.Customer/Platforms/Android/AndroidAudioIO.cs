...
using DeliveryApp.Customer.Services.Call;   // Driver: DeliveryApp.Driver.Services.Call

namespace DeliveryApp.Customer.Platforms.Android;   // Driver: DeliveryApp.Driver.Platforms.Android
